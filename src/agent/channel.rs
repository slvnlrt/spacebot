...
impl Channel {
    ...
    #[tracing::instrument(skip(self, user_text, system_prompt, attachment_content, injected_context, message_source), fields(channel_id = %self.id, agent_id = %self.deps.agent_id))]
