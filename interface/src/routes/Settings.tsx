...
import { Badge, Button, Input, SettingSidebarButton, Dialog, DialogContent, DialogHeader, DialogTitle, DialogDescription, DialogFooter, Select, SelectTrigger, SelectValue, SelectContent, SelectItem, Toggle, Slider, NumberStepper } from "@/ui";
...
type SectionId = "providers" | "channels" | "api-keys" | "server" | "opencode" | "worker-logs" | "memory-injection" | "updates" | "config-file";
type SectionId = "providers" | "channels" | "api-keys" | "secrets" | "server" | "opencode" | "worker-logs" | "memory-injection" | "updates" | "config-file";
