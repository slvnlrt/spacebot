...
- **v1.1 (multi-bot) / v2b / v2c / v3** — designed below, not yet built. (v1.1's watcher-parity sub-item is done via v1.2; what remains of v1.1 is the shared-listener multi-bot work. **v2b** = thread replies + card-button `Action.Submit`→`Interaction` + outbound reactions; **v2c** = streaming.)
